...
export default function Customers({ customers, loading, loadAllData, triggerToast }) {
            ...
            <div className="drawer-body" style={{ padding: '20px 0 0 0' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F1F5F9', paddingBottom: 10 }}>
                  ...
                  <span style={{ fontSize: '0.82rem', fontWeight: 700, color: '#0F172A' }}>
                    {selectedPaymentOrder.customerNameSnapshot || selectedCust?.name || 'Unknown Customer'}
                  </span>
                </div>
                    ...
                    <>
                      ...
                      <button 
                        onClick={() => setShareModalData({
                          ...
                          url: realRzpLink,
                          text: `Hi ${selectedPaymentOrder.customerNameSnapshot || selectedCust?.name || 'Customer'}, here is your Razorpay payment link for Ironing Service Booking BK2026${String(selectedPaymentOrder.id).padStart(4, '0')} (Total: ₹${selectedPaymentOrder.totalAmount?.toFixed(2)}):\n${realRzpLink}`,
              ...
              <div style={{ backgroundColor: '#F1F5F9', borderRadius: 12, padding: '16px 18px', marginBottom: 20 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.82rem', marginBottom: 6, color: '#475569' }}>
                  ...
                  <span>₹{(selectedPaymentOrder.totalAmount / 1.05).toFixed(2)}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.82rem', marginBottom: 6, color: '#475569' }}>
                  <span>GST (5%)</span>
                  <span>₹{(selectedPaymentOrder.totalAmount - (selectedPaymentOrder.totalAmount / 1.05)).toFixed(2)}</span>
                </div>
