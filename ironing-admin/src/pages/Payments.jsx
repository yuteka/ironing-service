              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <button 
                  onClick={() => setShareModalData({
                    ...
                    text: `Hi ${selectedPaymentOrder.customerNameSnapshot || 'Customer'}, here is your Tax Invoice PDF for Ironing Service Booking BK2026${String(selectedPaymentOrder.id).padStart(4, '0')}:\nhttp://${window.location.hostname}:3000/api/orders/${selectedPaymentOrder.id}/invoice`,
